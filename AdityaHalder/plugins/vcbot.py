...
@Client.on_message(
    commandpro([".ply", "ply", "pusu", "susu"]) & SUDOERS)
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/7d7e3169e7b59e6f9983f.jpg"
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await lel.edit("**🌹 𝐏𝐔𝐒𝐔🤞𝐀𝐝𝐝𝐞𝐝 💿 𝐒𝐨𝐧𝐠❗️\n🔊 𝐀𝐭 💞 𝐏𝐨𝐬𝐢𝐭𝐢𝐨𝐧 » `{}` 🌷 ...**".format(position),
    )
    else:
...
async def song(client, message):
    cap = "**🥀 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐁𝐲 ː [ℳ𝓇 𝒫𝒰𝒮𝒰](https://t.me/legend_pusu)**"
